...
@Component({
  selector: 'app-pharmacie-recherche',
  templateUrl: './pharmacie-recherche.page.html',
  styleUrls: ['./pharmacie-recherche.page.scss'],
})
export class PharmacieRecherchePage implements OnInit {
  tab: any[];
  company: Company;
  customer: any;
  result: any;
  ...
  ngOnInit() {
    let obj = {};
    this.tab = this.randomStorage.getContent();
  ...
  viewDetail(c: any, medicament: any) {
    console.log(medicament);
    medicament.display = !medicament.display;
  }
  addToCart(doc: any, medicament: any) {
    console.log(doc);
